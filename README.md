...
> **Note:** This plugin is compatible with both Filament v3 and v4. It uses the Filament Spatie Translatable Plugin v3 for both versions until v4 becomes available.
